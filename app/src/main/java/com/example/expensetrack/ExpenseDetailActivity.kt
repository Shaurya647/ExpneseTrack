...
class ExpenseDetailActivity : AppCompatActivity() {
    ...
    // onResume intentionally does not reload — onCreate already loads on first open.
    // If you need refresh after editing, use ActivityResultContracts instead.
                    ...
                    binding.apply {
                        ...
                        if (!expense.receiptUri.isNullOrEmpty()) {
                            try {
                                ...
                                // URI is no longer accessible (e.g. permission revoked)
